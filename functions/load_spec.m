...
index_s = (1:size(Spec.SeriesID))';
% Summarize model specification
fprintf('Table 1: Model specification \n');
try
    tabular = table(index_s,Spec.SeriesID,Spec.SeriesName,Spec.Units,Spec.UnitsTransformed,...
                'VariableNames',{'Index','SeriesID','SeriesName','Units','Transformation'});
    disp(tabular);
catch
end
